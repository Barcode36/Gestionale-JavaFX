...
public class Bracciale extends Gioiello
{
	...
	public Bracciale(String id, double prezzo, double peso, MATERIALE materiale, String genere, double lunghezza, double spessore, double larghezza)
	{
	...
	{
		return "Bracciale;"+super.getId() + ";" + super.getPrezzo() + ";" + super.getPeso() + ";" + super.getMateriale() + ";" + super.getGenere() + ";" + lunghezza + ";" + spessore + ";" + larghezza;
	}
